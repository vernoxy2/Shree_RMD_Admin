  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_student_attendance", editId), updateData);
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage student attendance by year</p>
        </div>
        <button
                      ...
                      <div className="flex items-center gap-3 min-w-0 pr-4">
                        ...
                        <div className="flex flex-col min-w-0">
                          <span className="text-sm font-semibold text-gray-800 line-clamp-2 leading-snug">
                            {rec.fileName || "Student Attendance"}
                          </span>
