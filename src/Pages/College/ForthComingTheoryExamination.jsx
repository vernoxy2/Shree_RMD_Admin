...
const ForthComingTheoryExamination = () => {
  ...
  const colRef = collection(db, "cllg_forthcoming_theory");
  const BUCKET_NAME = "Forthcoming-Theory-files";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_forthcoming_theory", editId), updateData);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_forthcoming_theory", rec.id));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Forth Coming Theory Examination</h1>
          <p className="text-sm text-gray-500 mt-1">Manage upcoming university theory exam schedules</p>
        </div>
        <button
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. BAMS March 2026 Theory Exam"
                    value={form.title}
...
export default ForthComingTheoryExamination;