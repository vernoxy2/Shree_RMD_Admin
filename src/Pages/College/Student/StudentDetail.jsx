...
const StudentDetail = () => {
  ...
  const colRef = collection(db, "cllg_student_details");
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_student_details", editId), updateData);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_student_details", rec.id));
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage student documents by year</p>
        </div>
        <button
