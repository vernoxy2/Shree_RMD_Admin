...
const Activities = () => {
  ...
  const colRef = collection(db, "cllg_student_activities");
  const BUCKET_NAME = "activities-files";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_student_activities", editId), updateData);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_student_activities", rec.id));
    ...
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Manage student activities by year</p>
        </div>
        <button
