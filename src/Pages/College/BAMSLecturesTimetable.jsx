...
const BAMSLecturesTimetable = () => {
  ...
  const colRef = collection(db, "cllg_bams_lectures_timetable");
  const BUCKET_NAME = "BAMS-Lectures-Timetable-files";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_bams_lectures_timetable", editId), updateData);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_bams_lectures_timetable", rec.id));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">BAMS Lectures Timetable</h1>
          <p className="text-sm text-gray-500 mt-1">Manage weekly lecture schedules for students</p>
        </div>
        <button
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1.5 ml-1">Timetable Title *</label>
                  <input
                    ...
                    placeholder="e.g. BAMS 1st Year Weekly Timetable"
                    value={form.title}
      ...
      {loading ? (
        ...
        <div className="text-center py-32 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
          ...
          <p className="text-gray-500 font-medium">No timetables found. Start by adding one.</p>
        </div>
      ) : (
...
export default BAMSLecturesTimetable;