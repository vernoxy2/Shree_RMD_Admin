...
const ForthComingPracticalExamination = () => {
  ...
  const colRef = collection(db, "cllg_forthcoming_practical");
  const BUCKET_NAME = "Forthcoming-Practical-files";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_forthcoming_practical", editId), updateData);
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_forthcoming_practical", rec.id));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Forth Coming Practical Examination</h1>
          <p className="text-sm text-gray-500 mt-1">Manage upcoming university practical exam schedules</p>
        </div>
        <button
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-8 w-full max-w-md border border-gray-100">
            <div className="flex justify-between items-center mb-6">
              <h2 className="text-xl font-bold text-gray-900">
                {editId ? "Edit Exam Details" : "Add New Exam Details"}
              </h2>
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    placeholder="e.g. BAMS March 2026 Practical Exam"
                    value={form.title}
...
export default ForthComingPracticalExamination;