...
const SyllabusDetail = () => {
  ...
  const colRef = collection(db, "cllg_syllabus_detail");
  const BUCKET_NAME = "Syllabus-Detail-files";
  ...
  const handleSubmit = async () => {
    ...
    try {
      if (editId) {
        ...
        await updateDoc(doc(db, "cllg_syllabus_detail", editId), updateData);
        ...
        showAlert("New syllabus added successfully!");
      }
      resetForm();
      fetchRecords();
    } catch (err) {
    ...
    showConfirm(
      ...
      async () => {
        try {
          ...
          await deleteDoc(doc(db, "cllg_syllabus_detail", rec.id));
  ...
  return (
    <div className="max-w-6xl mx-auto">
      ...
      <div className="flex justify-between items-center mb-8">
        <div>
          <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Syllabus Detail</h1>
          <p className="text-sm text-gray-500 mt-1">Manage course curriculum and syllabus documents</p>
        </div>
        <button
            ...
            <div className="space-y-5">
              <div className="grid grid-cols-2 gap-4">
                <div className="col-span-2">
                  <label className="text-xs font-bold text-gray-500 uppercase tracking-wider block mb-1.5 ml-1">Syllabus Title *</label>
                  <input
                    ...
                    placeholder="e.g. BAMS Revised Syllabus 2026"
                    value={form.title}
      ...
      {loading ? (
        ...
        <div className="text-center py-32 bg-gray-50 rounded-3xl border border-dashed border-gray-200">
          ...
          <p className="text-gray-500 font-medium">No syllabus records found. Start by adding one.</p>
        </div>
      ) : (
